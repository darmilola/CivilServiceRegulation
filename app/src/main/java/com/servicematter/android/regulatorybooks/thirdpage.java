    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String text = "Download Ondo State Civil Service Regulatory Books from Playstore  http://play.google.com/store/apps/details?id=com.servicematter.android.regulatorybooks";
