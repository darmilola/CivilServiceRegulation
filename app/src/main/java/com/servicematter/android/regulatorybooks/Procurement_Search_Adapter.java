...
public class Procurement_Search_Adapter extends RecyclerView.Adapter<Procurement_Search_Adapter.BookmarksViewHolder> {

    List<Procurement_Section> sectionList;
    String searchString;
    private ListItemClickListener mOnClickListener;

    public Procurement_Search_Adapter(List<Procurement_Section> sectionList,String searchString/*,ListItemClickListener listItemClickListener*/) {
    ...
    public void onBindViewHolder(@NonNull BookmarksViewHolder holder, int position) {
        Procurement_Section current = sectionList.get(position);
