...
public class Procurement_Bookmark_Adapter extends RecyclerView.Adapter<Procurement_Bookmark_Adapter.BookmarksViewHolder> {

    List<Procurement_Bookmark_Model> sectionList;
    private ListItemClickListener mOnClickListener;

    public Procurement_Bookmark_Adapter(List<Procurement_Bookmark_Model> sectionList/*,ListItemClickListener listItemClickListener*/) {
    ...
    public void onBindViewHolder(@NonNull BookmarksViewHolder holder, int position) {
        Procurement_Bookmark_Model current = sectionList.get(position);
