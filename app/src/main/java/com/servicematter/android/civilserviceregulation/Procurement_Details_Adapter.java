...
public class Procurement_Details_Adapter extends RecyclerView.Adapter<Procurement_Details_Adapter.ArticleDetailViewHolder>{

    List<Procurement_Section> sectionList;
    private ListItemClickListener mOnClickListener;

    public Procurement_Details_Adapter(List<Procurement_Section> sectionList,ListItemClickListener listItemClickListener){
