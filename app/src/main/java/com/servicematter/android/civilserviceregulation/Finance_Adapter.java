...
public class Finance_Adapter extends ExpandableRecyclerViewAdapter<ArticleViewHolder,SectionViewHolder> {

    Context context;
    public Finance_Adapter(List<? extends ExpandableGroup> groups, Context context) {
        super(groups);
